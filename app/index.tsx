...
export default function HomeScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + webTopPadding, paddingBottom: insets.bottom + webBottomPadding }]}>
      <LinearGradient
      ...
      >
        ...
        <View style={styles.featureRow}>
          ...
          >
            ...
            <Text style={styles.featureSubtitle}>30 Puzzles</Text>
          </Pressable>
        </View>
