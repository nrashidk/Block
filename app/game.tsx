...
export default function GameScreen() {
  ...
  const handlePowerUp = useCallback(
    ...
    [gameState.currentPieces, getHintPosition, usePowerUp]
  );
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + webTopPadding, paddingBottom: Platform.OS === "web" ? 34 : insets.bottom }]}>
      <LinearGradient
